...
/**
 * This class is abstract, so running it directly will simply run its only implementation
 * (`TestArrayDictionary`), which will inherit (and re-use) the tests defined here.
 *
...
abstract class BaseTestDictionary extends BaseTest {
